...
public class preConfig {
    ...
    public static void writeLoginPref(Context context, int login){
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences((context));
        SharedPreferences.Editor editor = pref.edit();
        editor.putInt("login_deactive", login);
        editor.apply();
    }

    public static void writeFriendPref(Context context, int friend){
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences((context));
        SharedPreferences.Editor editor = pref.edit();
        editor.putInt("friend_deactive", friend);
        editor.apply();
    }
    ...
    public static Integer readLoginPref(Context context){
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        Integer login = pref.getInt("login_deactive", 0);
        return login;
    }

    public static Integer readFriendPref(Context context){
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        Integer friend = pref.getInt("friend_deactive", 0);
        return friend;
    }
}
